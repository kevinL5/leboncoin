$(document).ready(function() {
	...
	$(
		"input[name='title'], textarea[name='description'], input[name='price'], input[name='type']"
	).click(function() {
		checkBoxWho()
		checkBoxType()
	})
	...
	function checkPassword() {
		...
		if ($(selector).val().length < 7 || $(selector).val().length > 101) {
			$(selector).addClass('is-invalid')
		} else {
			$(selector)
				.removeClass('is-invalid')
